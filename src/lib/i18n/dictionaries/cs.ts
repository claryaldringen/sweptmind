...
export const cs: Dictionary = {
  ...
  settings: {
    ...
    aiProviderDefault: "Výchozí (systémový)",
    aiProviderOpenai: "OpenAI kompatibilní",
    aiProviderOllama: "Ollama (lokální)",
    aiApiKey: "API klíč",
    aiApiKeyPlaceholder: "sk-...",
    aiBaseUrl: "Base URL (volitelné)",
    aiBaseUrlPlaceholder: "https://api.openai.com/v1",
    aiModelName: "Model",
    aiModelPlaceholder: "gpt-4o-mini",
    aiSaved: "AI nastavení uloženo",
    aiReset: "Obnovit výchozí",
  },
  common: {
    loading: "Načítání...",
    user: "Uživatel",
