...
export const en: Dictionary = {
  ...
  tasks: {
    ...
    iconDueDate: "Due date",
    iconReminder: "Reminder",
    iconRecurrence: "Recurrence",
    iconAttachments: "Attachments",
    iconBlocked: "Blocked by another task",
    iconDependents: "Blocks other tasks",
    iconConflict: "Time conflict",
    iconDevicePhone: "Phone task",
    iconDeviceDesktop: "Desktop task",
  },
  lists: {
    newList: "New list",
    listName: "List name",
  ...
  settings: {
    ...
    aiModel: "AI model",
    aiModelDesc:
      "Choose a model for task analysis. More powerful models have lower monthly limits.",
    aiUsage: "Usage this month",
    aiLimit: "{{count}} analyses/month",
  },
  common: {
    loading: "Loading...",
    user: "User",
  ...
  calendar: {
    ...
    calendarTargetList: "Target list for new events",
    calendarTargetListPlaceholder: "Select a list…",
  },
  context: {
    hereAndNow: "Here & Now",
    phone: "Phone",
  ...
  premium: {
    ...
    paymentFound: "Payment found! Premium is now active.",
    paymentNotFound: "Payment not found yet. Please try again in a moment.",
    nextCheckIn: "Next check in {seconds}s",
    aiAnalyzing: "Analyzing...",
    aiNotActionable: "This task is not a concrete next action",
    aiSuggestion: "AI suggestion",
    aiDecompose: "Break into steps",
    aiDecomposing: "Generating steps...",
    aiDuplicate: "This task seems identical to",
    aiDuplicateDelete: "Delete this task",
    aiRenameApply: "Rename",
    aiDecomposeApply: "Apply",
    aiDecomposeCancel: "Cancel",
    aiDecomposeEmpty: "AI found no steps to decompose",
    aiDecomposeError: "Failed to generate steps",
    aiDecomposeKeepInList: "Stays in current list",
    aiCallIntent: "You might want to call",
  ...
  sharing: {
    title: "Sharing",
    description: "Connect with other users to share tasks",
    ...
    inviteLogin: "Log in and accept",
    inviteRegister: "Create account",
    inviteExpired: "This invite has expired",
    inviteInvalid: "Invalid invite",
    alreadyConnected: "Already connected with this user",
    noConnections: "No connections yet. Create an invite to get started.",
